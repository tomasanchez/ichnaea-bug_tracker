...
public class TabContainer extends JTabbedPane {
    ...
    public Color getForegroundAt(int index) {
        return getSelectedIndex() == index ? SemanticColor.PRIMARY : SemanticColor.SECONDARY;
    }
    ...
    public class MaterialTabbedUI extends MetalTabbedPaneUI {
                ...
                public void stateChanged(ChangeEvent ce) {
                    ...
                    if (selected != -1) {
                        if (currentRectangle != null) {
                            ...
                            target = new PropertySetter(MaterialTabbedUI.this, "currentRectangle",
        ...
        protected void paintTabBackground(Graphics g, int tabPlacement, int tabIndex, int x, int y, int w, int h, boolean isSelected) {
            ...
            if (isSelected) {
                ...
                g.setColor(SemanticColor.LIGHT);
                g.fillRect(x, y, w, h);
            }
        }
        ...
        @Override
        protected void paintTabBorder(Graphics grphcs, int tabPlacement, int tabIndex, int x, int y,
                                      int w, int h, boolean isSelected) {
            Graphics2D g2 = (Graphics2D) grphcs.create();
            g2.setRenderingHint(RenderingHints.KEY_ANTIALIASING, RenderingHints.VALUE_ANTIALIAS_ON);
            g2.setColor(SemanticColor.PRIMARY);
