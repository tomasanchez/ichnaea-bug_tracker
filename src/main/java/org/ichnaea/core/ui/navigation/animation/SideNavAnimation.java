package org.ichnaea.core.ui.navigation.animation;
...
public class SideNavAnimation {

    private final MigLayout layout;
    private final NavItem menuItem;
    private Animator animator;
    private boolean open;

    public SideNavAnimation(MigLayout layout, Component component) {
        this.layout = layout;
        this.menuItem = (NavItem) component;
        initAnimator(component, 200);
    }

    public SideNavAnimation(MigLayout layout, Component component, int duration) {
        this.layout = layout;
        this.menuItem = (NavItem) component;
